...
export const traversalNodes: TraversalNode[] = [
  {
    ...
    topics: [
      { keyword: 'Defender XDR', description: 'Microsoft Defender XDR', started: true, completed: false },
      {
        keyword: 'Defender for Endpoint',
        description: 'Microsoft Defender for Endpoint',
				started: false,
        completed: false,
      },
      {
        keyword: 'Defender for Cloud',
        description: 'Microsoft Defender for Cloud',
				started: false,
        completed: false,
      },
			{ keyword: 'KQL', description: 'Kusto Query Language (KQL)', started: false, completed: false },
      { keyword: 'Sentinel', description: 'Microsoft Sentinel', started: false, completed: false },
      { keyword: 'Purview', description: 'Microsoft Purview', started: false, completed: false },
    ]
  },
];
